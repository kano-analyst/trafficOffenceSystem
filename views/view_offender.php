...
<body>
 ...
 <div class="hidden-print">          <h1 style="text-align: center;">KAROTA Traffic Offence Payment Invoice</h1>
     <button type-"submit" class="myButton" style="padding:10px;margin-right:30px;text-align: center;" onclick="print()">Print Invoice<button>
</div>
<?php
...
<table class="table">
        ...
        <tr class="active"><td colspan="3">Scan the QR Code to confirm payment<br/><img style="border:groove;padding:1px" height="100px" width=""src="../images/qr_code.png" alt="qr_code image"/></td>
          <td><img src="../images/remita.jpg" height="50px" width="100px" alt=""/></td>
            <td colspan="3" align="right"><h6>Payment Invoice</h6> <br/>Genereated on <?php echo date("D.d-M-Y");?><br/>
