    ...
    <body>
         <section id="main-content">
          <section class="wrapper site-min-height">
              ...
              <?php
     $query = "SELECT `id`, `name`, `chasis_no`, `vehicle_type`, `plate_no`, `offence`, `degree`, `confiscated_item`, `committed_location`, `committed_date`, `phone`, `remark` FROM `offenders` WHERE `reporting_officer`='$reporting_officer' ORDER BY `id` desc";
                 $results = mysqli_query($conn, $query);
                        echo '<table class="table table-hover">';

                     echo '<tr><th>ID</th><th>NAME</th><th>OFFENCE</th><th>DEGREE</th><th>VEHICLE TYPE</th>
                     <th>PLATE NUMBER</th><th>CHASIS NUMBER</th><th>DATE REPORTED</th><th>LOCATION</th></tr>';
                while ($row = mysqli_fetch_assoc($results)) {
                        ...
                        <a style="color:white;" href="officer_view_offender.php?identity='.$id.' ">View</a>
                        </button></td>';
                        echo '</tr>';
                 } 
                        echo '</table>';
